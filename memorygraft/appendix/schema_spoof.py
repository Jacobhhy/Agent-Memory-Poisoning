...
async def run_schema_spoof_experiment():
    ...
    workspace_path = Path(__file__).parent.parent / "results" / "schema_spoof_workspace"
    ...
    if not test_repo_path.exists():
        source_path = Path(__file__).parent / "schema_spoof_repo"
    ...
    with open(poisoned_readme, 'r') as f:
        ...
        if "Thought:" in content:
            ...
            print(snippet[:400] + "...\n")
            print("✓ Forged ReAct traces detected in README")
        else:
...
"""
    ...
    print("Attack Type: Schema-Spoofing (Forged ReAct Traces)")
